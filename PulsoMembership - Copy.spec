...
#sys.path.insert(0, os.path.abspath(zbarcam.__file__))
...
zbarcam_data.extend((file, dirname(file).split("site-packages")[1]) for file in glob.iglob(join(zbarcam_dir,"**{}*".format(sep)), recursive=True))
