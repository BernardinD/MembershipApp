...
class TestScanPage extends StatefulWidget with NavigationStates {
  TestScanPage({Key key, this.title}) : super(key: key);
  final String title;

  @override
  TestScanPageState createState() => TestScanPageState();
}

class TestScanPageState extends State<TestScanPage> {
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: RaisedButton(
                            onPressed: _signInEnabled ? () => setState(() => _signIn()) : null,
